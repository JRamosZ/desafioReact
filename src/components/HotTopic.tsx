  ...
  return (
    <div className="card w-100">
      <div className="d-flex justify-content-between bg-light">
        <p id="relevantLatestAuthor" className="mb-0 ps-3 py-2">
          Hot At The Moment 🔥
        </p>
      ...
      <div className="card-body">
        ...
        <p id="relevantLatestContent" className="card-text">
          {`${props.data.postContent.slice(0, 160)}...`}
        </p>
      </div>
    </div>
  );
