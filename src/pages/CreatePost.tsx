...
export default function CreatePost() {
  ...
  useEffect(() => {
    ...
    if (payloadUser) {
      setUserId(JSON.parse(atob(payloadUser)).id);
      if (userId) {
      ...
      <header className="container-fluid">
        <div className="nav_bar container-lg justify-content-between d-flex pt-2 pb-2 pe-0">
          ...
          <div className="nav_bar_conteiner_login">
            ...
            <button className="button_preview" type="button">
              <b>Preview</b>
            </button>
          </div>
          <button
        ...
        <div className="row px-2">
          <div className="d-flex gap-2">
            ...
            <div className="col-12 col-md-8 col-xl-5 px-0">
              ...
              >
                <div
                  className="py-3 px-5 border border-1
                ...
                >
                  ...
                  <input
                    ...
                    {...register("postReadTime", {
                      required: {
                        value: true,
                        message: "Post Read Time Required",
                      },
                    })}
                  />
                  ...
                  />
                  <div className="editor-bar  d-flex justify-content-between align-items-center px-5">
                    <div>
                      <button
                        type="button"
                        data-bs-toggle="tooltip"
                  ...
                  <div className="py-3 mb-4 bottom-round bg-white">
